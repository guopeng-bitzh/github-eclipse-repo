<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%
   String cxk = request.getContextPath();
...
<style>
.background1 {
	background-image: url({cxk}/static/imgs/pic008.jpg);
...
<script src="{cxk}/static/jquery.min.js"></script>
</head>
<body class="background1">
	<audio id="intr" controls="controls"
		src="{cxk}/static/audio/introduction.mp3" autoplay="autoplay"></audio>
	<audio id="poem" src="{cxk}/static/audio/wanderingEarch-poem.mp3"
		preload="auto"></audio>
	...
	<audio id="waiting" src="{cxk}/static/audio/waiting.mp3" preload="auto" onended="onWaitingAudioEnd();"></audio>
	<div id="poem-txt"
	...
	<img src="{cxk}/static/imgs/earth.png"
	...
	<div id="moviebox" style="margin-top: 100px; display: none"
		...
		<video id="movie" height="300px" controls="controls"
			src="{cxk}/static/video/movie.mp4" onended="onVideoEnd();" />
	</div>
